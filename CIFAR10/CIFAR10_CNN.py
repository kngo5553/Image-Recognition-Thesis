...
# Convolution layers
model.add(Conv2D(64, (3, 3), padding='same', input_shape=x_train.shape[1:], name="INPUT"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Conv2D(64, (3, 3), padding='same', name="conv2d_32"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
...
model.add(Conv2D(128, (3, 3), padding='same', name="conv2d_64"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Conv2D(128, (3, 3), padding='same', name="conv2d_64_1"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.2))
...
model.add(Conv2D(256, (3, 3), padding='same', name="conv2d_128"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Conv2D(256, (3, 3), padding='same', name="conv2d_128_1"))
model.add(Activation(activationFN))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.2))
